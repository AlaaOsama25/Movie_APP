...
class TopRatedScreenDetails extends StatefulWidget {
  const TopRatedScreenDetails({Key? key,required this.index,required this.page}) : super(key: key);

  final index;
  final  page;
  @override
  _TopRatedScreenDetailsState createState() =>
      _TopRatedScreenDetailsState(index:index,page:page);
}

class _TopRatedScreenDetailsState extends State<TopRatedScreenDetails> {
  _TopRatedScreenDetailsState({ this.index,required this.page});
  final index;
  final int page;
