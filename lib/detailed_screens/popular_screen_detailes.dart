...
class PopularScreenDetails extends StatefulWidget {
  const PopularScreenDetails({Key? key,required this.index,required this.page}) : super(key: key);
 final index;
 final  page;
  @override
  _PopularScreenDetailsState createState() =>
      _PopularScreenDetailsState(index:index,page:page);
}

class _PopularScreenDetailsState extends State<PopularScreenDetails> {
  _PopularScreenDetailsState({ this.index,required this.page});
  final index;
  final int page;
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    decoration: BoxDecoration(
                        image: (info![index]!.backdropPath == null)
                                      ? DecorationImage(
                                          fit: BoxFit.cover,
                                          image: AssetImage(
                                              'images/default movie dropposter.jpg'))
                                      : DecorationImage(
                                          fit: BoxFit.cover,
                                          image: NetworkImage(
